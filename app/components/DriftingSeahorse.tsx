...
// Gentle drifting seahorse watermark animation (bottom-right)
export default function DriftingSeahorse() {
  ...
  return (
    <div aria-hidden className="fixed pointer-events-none z-40 right-4 bottom-4 sm:right-6 sm:bottom-6">
      <img
        src="/favicon.svg"
